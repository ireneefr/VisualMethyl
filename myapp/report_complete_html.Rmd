...
```
```{r red_intensities, echo=FALSE, eval=!is.null(params$red_intensities), results='asis'}
cat("\n")
cat("#####\n")
cat("\n")
...
cat("* Drop SNPs: ", params$dropsnps, if(params$dropsnps){ cat("minimum MAF filtered: ", params$maf)})
