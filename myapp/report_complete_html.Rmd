...
```{r statistics, echo=FALSE, eval=!is.null(params$surv_stat), results='asis'}
cat("\n### Statistics")
```
```{r plot_statistics, echo=FALSE, warning=FALSE, message=FALSE, eval=!is.null(params$surv_stat)}
params$surv_stat
```
