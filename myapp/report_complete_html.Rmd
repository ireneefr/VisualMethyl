...
cat("\n### KEGG")
```
```{r plot_kegg, echo = FALSE, warning = FALSE, message = FALSE, eval = !is.null(params$kegg), fig.width=15}
params$kegg
```
...
```
```{r plot_mf, echo=FALSE, warning=FALSE, message=FALSE, eval=!is.null(params$go_mf), fig.width=15}
params$go_mf
```
...
```
```{r plot_bp, echo=FALSE, warning=FALSE, message=FALSE, eval=!is.null(params$go_bp), fig.width=20}
params$go_bp
```
...
```
```{r plot_cc, echo=FALSE, warning=FALSE, message=FALSE, eval=!is.null(params$go_cc), fig.width=20}
params$go_cc
```
...
cat("\n### Reactome")
```
```{r plot_reactome, echo=FALSE, warning=FALSE, message=FALSE, eval=!is.null(params$reactome), fig.width=10}
params$reactome
```
