    ...
    dashboardSidebar(
      ...
      sidebarMenu(
        ...
        convertMenuItem(menuItem("Analysis",
          tabName = "analysis", startExpanded = TRUE,
      ...
      tabItems(
        ...
        tabItem(
          ...
          fluidPage(
            ...
            mainPanel(id = "vertical",
              ...
              verticalLayout(
                box(
                  title = "INTENSITIES BOXPLOTS", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
                ...
                box(
                  title = "CONTROL TYPES", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
                ...
                box(
                  title = "SNP ANALYSIS", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
                  h4("SNPs beta-values (Raw)"),
                  withSpinner(plotly::plotlyOutput("graph_minfi_snps"))
                ),
                box(
                  title = "BATCH EFFECTS", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
                  h4("Normalized"),
        ...
        tabItem(
          ...
          fluidPage(id = "exploratory_plots",
            verticalLayout(
              ...
              box(
                title = "HEATMAP", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
                h4("Random 1000 CpGs"),
              ...
              box(
                title = "DECONVOLUTION", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
                withSpinner(plotOutput("deconvolution_heatmap"))
              ),
              box(
                title = "AGE METH", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
              ...
              # ),
              box(
                title = "HYPO/HYPER", width = 12, collapsible = TRUE, collapsed = TRUE, status = "primary",
                sliderInput(
                  inputId = "slider_beta",
            ...
            tabsetPanel(
              tabPanel("DMPs", style = "margin-top: 10px;", sidebarLayout(
                ...
                mainPanel(
                  ...
                  div(id = "div_dmp_plots",
                  fluidRow(
                  box(
                    title = "DMP HEATMAP", width = 12, closable = FALSE, collapsible = TRUE, collapsed = TRUE, status = "primary",
                  ...
                  box(
                    title = "DMPs ANNOTATION", width = 12, closable = FALSE, collapsible = TRUE, collapsed = TRUE, status = "primary",
                    h4("DMP Boxplot"),
                  ...
                  box(
                    title = "DMP MANHATTAN", width = 12, closable = FALSE, collapsible = TRUE, collapsed = TRUE, status = "primary",
              ...
              tabPanel("DMRs", style = "margin-top: 10px;", 
                sidebarLayout(
                sidebarPanel(
                  width = 3,
                  div(id = "div_dmr_calculation_options",
                  pickerInput(
                ...
                mainPanel(
                  ...
                  div(id = "div_dmr_plots",
                      fluidRow(
                  box(
                    title = "DMR HEATMAP", width = 12, closable = FALSE, collapsible = TRUE, collapsed = TRUE, status = "primary",
                    h4("DMRs Heatmap"),
                  ...
                  box(
                    title = "DMR ANNOTATION", width = 12, closable = FALSE, collapsible = TRUE, collapsed = TRUE, status = "primary",
                    h4("Genomic graph"),
        ...
        tabItem(
          ...
          fluidPage(
            ...
            box(
              title = "Gene Ontology (GO)", width = 12, closable = FALSE, collapsible = TRUE, collapsed = TRUE, status = "primary",
